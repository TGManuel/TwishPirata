...
import { getChannels as getChannelsRequest, getFollowwedChannels } from "../../services/api";
...
export const useChannels = () => {
    ...
    const getChannels = async (isLogged = false) => {
        ...
        const followedChannelsData = await getFollowwedChannels();
        ...
        setChannels({
            channels: channelsData.data.channels,
            followedChannels: channelsData.data.channels.filter(chanel => 
                followedChannelsData.data.followedChannels.includes(chanel.id)
            )
        });
    }
